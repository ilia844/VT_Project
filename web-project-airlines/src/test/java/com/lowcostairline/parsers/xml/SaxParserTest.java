...
public class SaxParserTest {
    ...
    public void parse() throws ParserException {
        ...
        List<LowCostAirlineTrip> expected = Arrays.asList(lowCostAirlineTripBlueSky,lowCostAirlineTripAmerican);
        //then
        SaxParser saxParser = new SaxParser(new PlanHandler());
        List<LowCostAirlineTrip> actuallyPlans =saxParser.parse(xmlPath);
